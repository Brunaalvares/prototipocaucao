...
Protótipo estático da Caução Digital by Avalyst.
...
- `blog/index.html` — página de artigos e conteúdos do blog.
- `blog/fiador-seguro-fianca-ou-caucao-digital/index.html` — página de post do blog.
...
Essa estrutura permite deploy direto na Vercel como site estático, usando `index.html` como arquivo de entrada.
